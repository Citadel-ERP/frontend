...
const INITIAL_NEW_SITE = {
  ...
  // Scout-specific field preserved
  maintenance_rate: '',
};
...
const CreateNewSite: React.FC<CreateNewSiteProps> = ({
  ...
  const pickImageFromGallery = async () => {
    ...
    try {
      ...
      // Scout-specific: multiple selection preserved
  ...
  const handleCreateSite = async () => {
    ...
    try {
      ...
      const siteData: any = {
        ...
        // Scout-specific: lat/lng from device
      ...
      if (newSite.stilt) siteData.stilt = newSite.stilt;
      ...
      // 2-Wheeler: free text — send as-is without numeric coercion
      ...
      // Scout-specific: 'building_photos' field name
