...
const Login: React.FC<LoginProps> = ({
   ...
   try {
     ...
     if (error && error.message) {
       ...
       if (msg.includes('invalid email') || 
           ...
           msg.includes('wrong') ||
           msg.includes('400')) {
         errorMessage = 'You entered the wrong email and password';
 ...
 // On web, don't use TouchableWithoutFeedback wrapper
 const content = (
 ...
 // Only wrap with TouchableWithoutFeedback on mobile
 if (Platform.OS === 'web') {
   return content;
 }
