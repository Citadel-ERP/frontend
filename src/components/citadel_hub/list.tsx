...
const styles = StyleSheet.create({
  ...
  contextMenu: { backgroundColor: '#ffffff', borderRadius: 8, minWidth: 200, paddingVertical: 8, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5 },
  contextMenuItem: { paddingVertical: 12, paddingHorizontal: 20 },
  contextMenuText: { fontSize: 14, color: '#111b21' },
